...
class CreateUsersAbout extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_about', function (Blueprint $table) {
            ...
            $table->string('favourite_music_genre', 255)->nullable();
            $table->string('favourite_books', 255)->nullable();
            $table->string('favourite_music', 255)->nullable();
            $table->string('favourite_movies', 255)->nullable();
            $table->string('favourite_games', 255)->nullable();
            $table->string('favourite_brands', 255)->nullable();
            $table->string('favourite_artists', 255)->nullable();
            $table->string('favourite_interests', 255)->nullable();
