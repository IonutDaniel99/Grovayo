...
Route::middleware(['auth:sanctum', 'verified'])->get('/Home', 'App\Http\Controllers\HomeController@index')->name('Home');

Route::middleware(['auth:sanctum', 'verified'])->get('/Discussion', 'App\Http\Controllers\DiscussionController@index')->name('Discussion');

Route::middleware(['auth:sanctum', 'verified'])->get('/Weather', 'App\Http\Controllers\WeatherController@index')->name('Weather');
Route::post('/Weather/Store', 'App\Http\Controllers\WeatherController@store')->name('weather.store');

Route::middleware(['auth:sanctum', 'verified'])->get('/Blog', 'App\Http\Controllers\BlogController@index')->name('Blog');

Route::middleware(['auth:sanctum', 'verified'])->get('/Profile', 'App\Http\Controllers\ProfileController@index')->name('Profile');



// ######################## Profile Page ###########################
Route::middleware(['auth:sanctum', 'verified'])->get('/Activity', 'App\Http\Controllers\MainProfile\ActivityController@index')->name('ProfileActivity');

Route::middleware(['auth:sanctum', 'verified'])->get('/About', function () {
    return view('livewire.profile.about');
})->name('ProfileAbout');
Route::middleware(['auth:sanctum', 'verified'])->get('/Profile-Discussion', function () {
    return view('livewire.profile.discussion');
})->name('ProfileDiscussion');
Route::middleware(['auth:sanctum', 'verified'])->get('/Followers', function () {
    return view('livewire.profile.followers');
})->name('ProfileFollowers');
Route::middleware(['auth:sanctum', 'verified'])->get('/Following', function () {
...
// ####################### Personal Info #################################
Route::middleware(['auth:sanctum', 'verified'])->get('/Personal-Info', 'App\Http\Controllers\MainProfile\Settings\PersonalInfoController@index')->name("Settings_Personal_Info_Index");
...
Route::middleware(['auth:sanctum', 'verified'])->get('/Profile', 'App\Http\Controllers\MainProfile\Settings\ProfileController@index')->name("Settings_Profile_Index");
...
Route::middleware(['auth:sanctum', 'verified'])->get('/Requests', 'App\Http\Controllers\MainProfile\Settings\FriendsRequests@index')->name("Settings_Friends_Request_Index");
...
Route::middleware(['auth:sanctum', 'verified'])->get('/Notifications', 'App\Http\Controllers\MainProfile\Settings\NotificationController@index')->name("Settings_All_Notification_Index");
...
Route::middleware(['auth:sanctum', 'verified'])->get('/Social-Networks', 'App\Http\Controllers\MainProfile\Settings\SocialNetworksController@index')->name("Settings_Social_Networks_Index");
...
Route::middleware(['auth:sanctum', 'verified'])->get('/Email-Settings', 'App\Http\Controllers\MainProfile\Settings\EmailSettingsController@index')->name("Settings_Email_Index");
...
Route::middleware(['auth:sanctum', 'verified'])->get('/Notification-Settings', 'App\Http\Controllers\MainProfile\Settings\NotificationSettingsController@index')->name("Settings_User_Notification_Index");
...
Route::middleware(['auth:sanctum', 'verified'])->get('/Security', 'App\Http\Controllers\MainProfile\Settings\SecurityController@index')->name("Settings_Security_Index");

// ####################### Change Password #################################

Route::middleware(['auth:sanctum', 'verified'])->get('/Change-Password', 'App\Http\Controllers\MainProfile\Settings\ChangePasswordController@index')->name("Settings_Change_Password_Index");
...
Route::middleware(['auth:sanctum', 'verified'])->get('/Disable-Account', 'App\Http\Controllers\MainProfile\Settings\DisableAccountController@index')->name("Settings_Disable_Account_Index");
