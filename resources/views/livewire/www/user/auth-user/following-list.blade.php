                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="user-data full-width">
                            <div class="user-profile">
                                <div class="userbg-dt dpbg dpbg-border"
                                    style="background-image:url({{$follower['follower_request_background_photo']}});">
                                    <div class="usr-pic">
                                        @if($follower['follower_request_profile_photo'] == NULL)
                                        <img src="https://ui-avatars.com/api/?name={{$follower['follower_request_username']}}&color=7F9CF5&background=EBF4FF"
                                            alt="{{$follower['follower_request_username']}}">
                                        @else
                                        <img src="/{{$follower['follower_request_profile_photo']}}"
                                            alt="{{$follower['follower_request_username']}}">
                                        @endif
                                    </div>
                                </div>
                                <div class="user-main-details">
                                    ...
                                    <h6 style="color: #adadad;text-decoration: underline;">
                                        {{$follower['follower_request_username']}}</h6>
                                    <span><i class="fas fa-map-marker-alt"></i>
                                        @if($follower['follower_request_country'] == NULL)
                                        Unspecified
                                        @else
                                        {{$follower['follower_request_state']}} /
                                        {{$follower['follower_request_country']}}
                                        @endif
                                    </span>
                                </div>
                                    ...
                                    <li>
                                        <div class="follow-dt-sm">
                                            <button class="follow-btn1"
                                                wire:click="deleteFollow({{$follower['follower_request_id']}})">Delete
                                                Follow</button>
                                        </div>
                                    </li>
                                </ul>
