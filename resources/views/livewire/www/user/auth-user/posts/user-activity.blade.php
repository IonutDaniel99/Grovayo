<div id="activity-post-component">
    ...
    <div class="activity-posts animate__animated animate__backInDown" wire:key="post_{{ $post['id']}}">
    ...
    <div wire:ignore.self class="modal " id="exampleModalCenter{{ $post['id']}}" role="dialog" aria-labelledby="exampleModalCenterTitle{{ $post['id']}}" aria-hidden="true" wire:key="modal_{{ $post['id']}}">
