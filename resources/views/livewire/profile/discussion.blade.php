                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                <div class="dis-img-text">
                                                    <img src="images/discussion/img-0.jpg" alt="">
                                                    <a href="single_discussion_view.html">
                                                        <h4>ellentesque vitae metus at neque cursus finibus.</h4>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                <div class="dis-img-text">
                                                    <img src="images/discussion/img-0.jpg" alt="">
                                                    <a href="single_discussion_view.html">
                                                        <h4>Cras vel lorem gravida, ullamcorper mi sed.</h4>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                <div class="dis-img-text">
                                                    <img src="images/discussion/img-0.jpg" alt="">
                                                    <a href="single_discussion_view.html">
                                                        <h4>Obortis risus. Nunc egestas arcu sit amet blandit finibus.</h4>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                <div class="dis-img-text">
                                                    <img src="images/discussion/img-0.jpg" alt="">
                                                    <a href="single_discussion_view.html">
                                                        <h4>Quisque in purus ut velit facilisis consequat ac id eros. </h4>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                <div class="dis-img-text">
                                                    <img src="images/discussion/img-0.jpg" alt="">
                                                    <a href="single_discussion_view.html">
                                                        <h4>Pellentesque semper urna est, non egestas massa vestibulum a.</h4>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                <div class="dis-img-text">
                                                    <img src="images/discussion/img-0.jpg" alt="">
                                                    <a href="single_discussion_view.html">
                                                        <h4>Nunc maximus mauris non tincidunt tincidunt.</h4>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                <div class="dis-img-text">
                                                    <img src="images/discussion/img-0.jpg" alt="">
                                                    <a href="single_discussion_view.html">
                                                        <h4>Sed vehicula, ligula quis efficitur suscipit, risus diam ultrices nisi.</h4>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                <div class="dis-img-text">
                                                    <img src="images/discussion/img-0.jpg" alt="">
                                                    <a href="single_discussion_view.html">
                                                        <h4>Etiam blandit, nisl sit amet mollis gravida, est ante porttitor dolor.</h4>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-8 col-md-12 col-sm-12">
                                                <div class="dis-img-text">
                                                    <img src="images/discussion/img-0.jpg" alt="">
                                                    <a href="single_discussion_view.html">
                                                        <h4>Maecenas erat augue, venenatis vel lacus nec, blandit volutpat nisl.</h4>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
