@if(Route::current()->getName() === 'Settings_Personal_Info_Index')
<div class="categories-items">
    ...
    <a class="tab-item-1" href="{{ route('Settings_All_Notification_Index') }}">All Notifications</a>
...
@elseif(Route::current()->getName() === 'Settings_Profile_Index')
<div class="categories-items">
...
@elseif(Route::current()->getName() === 'Settings_Friends_Request_Index')
<div class="categories-items">
    <a class="tab-item-1" href="{{ route('Settings_Personal_Info_Index') }}">Personal Info</a>
    <a class="tab-item-1 " href="{{ route('Settings_Profile_Index') }}">Profile</a>
...
@elseif(Route::current()->getName() === 'Settings_All_Notification_Index')
<div class="categories-items">
    <a class="tab-item-1" href="{{ route('Settings_Personal_Info_Index') }}">Personal Info</a>
    <a class="tab-item-1 " href="{{ route('Settings_Profile_Index') }}">Profile</a>
    <a class="tab-item-1" href="{{ route('Settings_Friends_Request_Index') }}">All Friend Requests</a>
    <a class="tab-item-1 active" href="{{ route('Settings_All_Notification_Index') }}">All Notifications</a>
    <a class="tab-item-1" href="{{ route('Settings_Social_Networks_Index') }}">Social Networks</a>
    <a class="tab-item-1" href="{{ route('Settings_Email_Index') }}">Email Setting</a>
    <a class="tab-item-1" href="{{ route('Settings_User_Notification_Index') }}">Notification Setting</a>
    <a class="tab-item-1" href="{{ route('Settings_Security_Index') }}">Security and Connectivity</a>
...
@elseif(Route::current()->getName() === 'Settings_Social_Networks_Index')
<div class="categories-items">
    <a class="tab-item-1" href="{{ route('Settings_Personal_Info_Index') }}">Personal Info</a>
    <a class="tab-item-1 " href="{{ route('Settings_Profile_Index') }}">Profile</a>
    <a class="tab-item-1" href="{{ route('Settings_Friends_Request_Index') }}">All Friend Requests</a>
...
@elseif(Route::current()->getName() === 'Settings_Email_Index')
<div class="categories-items">
    <a class="tab-item-1" href="{{ route('Settings_Personal_Info_Index') }}">Personal Info</a>
    <a class="tab-item-1 " href="{{ route('Settings_Profile_Index') }}">Profile</a>
    <a class="tab-item-1" href="{{ route('Settings_Friends_Request_Index') }}">All Friend Requests</a>
...
@elseif(Route::current()->getName() === 'Settings_User_Notification_Index')
<div class="categories-items">
    <a class="tab-item-1" href="{{ route('Settings_Personal_Info_Index') }}">Personal Info</a>
    <a class="tab-item-1 " href="{{ route('Settings_Profile_Index') }}">Profile</a>
    <a class="tab-item-1" href="{{ route('Settings_Friends_Request_Index') }}">All Friend Requests</a>
...
@elseif(Route::current()->getName() === 'Settings_Security_Index')
<div class="categories-items">
    <a class="tab-item-1" href="{{ route('Settings_Personal_Info_Index') }}">Personal Info</a>
    <a class="tab-item-1 " href="{{ route('Settings_Profile_Index') }}">Profile</a>
    <a class="tab-item-1 " href="{{ route('Settings_Friends_Request_Index') }}">All Friend Requests</a>
    ...
    <a class="tab-item-1" href="{{ route('Settings_Email_Index') }}">Email Setting</a>
    <a class="tab-item-1" href="{{ route('Settings_User_Notification_Index') }}">Notification Setting</a>
    <a class="tab-item-1 active" href="{{ route('Settings_Security_Index') }}">Security and Connectivity</a>
    <a class="tab-item-1" href="{{ route('Settings_Change_Password_Index') }}">Change Password</a>
    <a class="tab-item-1" href="{{ route('Settings_Disable_Account_Index') }}">Delete Account</a>
</div>
@elseif(Route::current()->getName() === 'Settings_Change_Password_Index')
<div class="categories-items">
    <a class="tab-item-1" href="{{ route('Settings_Personal_Info_Index') }}">Personal Info</a>
    <a class="tab-item-1" href="{{ route('Settings_Profile_Index') }}">Profile</a>
    <a class="tab-item-1" href="{{ route('Settings_Friends_Request_Index') }}">All Friend Requests</a>
    ...
    <a class="tab-item-1" href="{{ route('Settings_User_Notification_Index') }}">Notification Setting</a>
    <a class="tab-item-1" href="{{ route('Settings_Security_Index') }}">Security and Connectivity</a>
    <a class="tab-item-1 active" href="{{ route('Settings_Change_Password_Index') }}">Change Password</a>
    <a class="tab-item-1" href="{{ route('Settings_Disable_Account_Index') }}">Delete Account</a>
</div>
@elseif(Route::current()->getName() === 'Settings_Disable_Account_Index')
<div class="categories-items">
    <a class="tab-item-1" href="{{ route('Settings_Personal_Info_Index') }}">Personal Info</a>
    <a class="tab-item-1" href="{{ route('Settings_Profile_Index') }}">Profile</a>
    <a class="tab-item-1" href="{{ route('Settings_Friends_Request_Index') }}">All Friend Requests</a>
    ...
    <a class="tab-item-1" href="{{ route('Settings_Security_Index') }}">Security and Connectivity</a>
    <a class="tab-item-1" href="{{ route('Settings_Change_Password_Index') }}">Change Password</a>
    <a class="tab-item-1 active" href="{{ route('Settings_Disable_Account_Index') }}">Delete Account</a>
</div>
@endif