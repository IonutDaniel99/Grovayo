                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="mt-2 setting-dp">
                                                        <img src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" class="h-20 w-20 object-cover" id="profileProfileImage">
                                                    </div>
                                                    <div class="addpic" id="OpenImgUpload">
                                                        <form action="{{ route('Settings_Profile_Profile_Photo') }}" method="post" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            <label class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:text-gray-800 active:bg-gray-50 transition ease-in-out duration-150" for="my_profile_file">SELECT A NEW PHOTO</label>
                                                            <input type="file" id="my_profile_file" name="profile_image" onchange="load_profile_file(event)">
                                                            <div class="add-profile-btn">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="setting-bg">
                                                        <img src="{{Auth::user()->background_image_url}}" alt="{{Auth::user()->background_image_url}}" id="profileBackgroundImage">
                                                    </div>
                                                    <div class="setting-upload">
                                                        <div class="addpic" id="OpenImgUpload">
                                                            <form action="{{ route('Settings_Profile_Background_Photo') }}" method="post" enctype="multipart/form-data">
                                                                {{ csrf_field() }}
                                                                <label class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:text-gray-800 active:bg-gray-50 transition ease-in-out duration-150" for="my_background_file">SELECT A NEW BACKGROUND</label>
                                                                <input type="file" id="my_background_file" name="background_image" onchange="load_background_file(event)">
                                                                <div class="add-profile-btn">
                                                                    <button class="setting-save-btn inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150" type="sub">SAVE</button>
                                                                </div>
                                                            </form>
